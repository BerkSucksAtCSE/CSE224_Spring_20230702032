module semi_cpu_top (clk,
 ...
 sky130_fd_sc_hd__or4_1 _2490_ (.A(\IM0.addr[27] ),
    ...
    .VPWR(VPWR),
    .X(_0782_));
 sky130_fd_sc_hd__or4_1 _2491_ (.A(\IM0.addr[31] ),
    .B(\IM0.addr[30] ),
    .C(\IM0.addr[29] ),
    .D(\IM0.addr[28] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0783_));
 sky130_fd_sc_hd__or4_1 _2492_ (.A(\IM0.addr[23] ),
    .B(\IM0.addr[22] ),
    .C(\IM0.addr[21] ),
    .D(\IM0.addr[20] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0784_));
 sky130_fd_sc_hd__or4_1 _2493_ (.A(\IM0.addr[19] ),
    .B(\IM0.addr[18] ),
    .C(\IM0.addr[17] ),
    .D(\IM0.addr[16] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0785_));
 sky130_fd_sc_hd__nor4_1 _2494_ (.A(_0782_),
    .B(_0783_),
    .C(_0784_),
    .D(_0785_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0786_));
 sky130_fd_sc_hd__buf_2 _2495_ (.A(net48),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or4_1 _2496_ (.A(\IM0.addr[15] ),
    ...
    .VPWR(VPWR),
    .X(_0788_));
 sky130_fd_sc_hd__or4_1 _2497_ (.A(\IM0.addr[11] ),
    .B(\IM0.addr[10] ),
    .C(\IM0.addr[9] ),
    .D(\IM0.addr[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0789_));
 sky130_fd_sc_hd__or4_1 _2498_ (.A(\IM0.addr[7] ),
    .B(\IM0.addr[6] ),
    .C(\IM0.addr[5] ),
    .D(\IM0.addr[4] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _2499_ (.A1(\IM0.addr[2] ),
    ...
    .VPWR(VPWR),
    .X(_0791_));
 sky130_fd_sc_hd__nor4_1 _2500_ (.A(_0788_),
    .B(_0789_),
    .C(_0790_),
    .D(_0791_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_4 _2515_ (.A(_0806_),
    ...
    .VPWR(VPWR),
    .X(_0807_));
 sky130_fd_sc_hd__and3_1 _2516_ (.A(_0793_),
    .B(_0787_),
    .C(_0807_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 _2527_ (.A(\IM0.addr[2] ),
    ...
    .VPWR(VPWR),
    .X(_0819_));
 sky130_fd_sc_hd__buf_2 _2528_ (.A(\IM0.addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a211o_1 _2531_ (.A1(_0819_),
    ...
    .VPWR(VPWR),
    .X(_0823_));
 sky130_fd_sc_hd__or2_1 _2532_ (.A(_0801_),
    .B(_0823_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _2577_ (.A_N(_0821_),
    ...
    .VPWR(VPWR),
    .X(_0869_));
 sky130_fd_sc_hd__or3_1 _2578_ (.A(_0821_),
    .B(_0796_),
    .C(_0858_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a221o_1 _2608_ (.A1(\RF0.regs[10][18] ),
    ...
    .VPWR(VPWR),
    .X(_0900_));
 sky130_fd_sc_hd__clkbuf_4 _2609_ (.A(_0857_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _2812_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_1104_));
 sky130_fd_sc_hd__and2_1 _2813_ (.A(\IM0.addr[31] ),
    .B(_1104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2814_ (.A(_1105_),
    ...
    .VPWR(VPWR),
    .X(_0776_));
 sky130_fd_sc_hd__and2_1 _2815_ (.A(\IM0.addr[30] ),
    .B(_1104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _2890_ (.A1(net1),
    ...
    .VPWR(VPWR),
    .Y(_0745_));
 sky130_fd_sc_hd__clkbuf_1 _2891_ (.A(\RF0.regs[0][31] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2892_ (.A(_1151_),
    ...
    .VPWR(VPWR),
    .X(_0744_));
 sky130_fd_sc_hd__clkbuf_1 _2893_ (.A(\RF0.regs[0][30] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2894_ (.A(_1152_),
    ...
    .VPWR(VPWR),
    .X(_0743_));
 sky130_fd_sc_hd__clkbuf_1 _2895_ (.A(\RF0.regs[0][29] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2896_ (.A(_1153_),
    ...
    .VPWR(VPWR),
    .X(_0742_));
 sky130_fd_sc_hd__clkbuf_1 _2897_ (.A(\RF0.regs[0][28] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2898_ (.A(_1154_),
    ...
    .VPWR(VPWR),
    .X(_0741_));
 sky130_fd_sc_hd__clkbuf_1 _2899_ (.A(\RF0.regs[0][27] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2900_ (.A(_1155_),
    ...
    .VPWR(VPWR),
    .X(_0740_));
 sky130_fd_sc_hd__clkbuf_1 _2901_ (.A(\RF0.regs[0][26] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2902_ (.A(_1156_),
    ...
    .VPWR(VPWR),
    .X(_0739_));
 sky130_fd_sc_hd__clkbuf_1 _2903_ (.A(\RF0.regs[0][25] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2904_ (.A(_1157_),
    ...
    .VPWR(VPWR),
    .X(_0738_));
 sky130_fd_sc_hd__clkbuf_1 _2905_ (.A(\RF0.regs[0][24] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2906_ (.A(_1158_),
    ...
    .VPWR(VPWR),
    .X(_0737_));
 sky130_fd_sc_hd__clkbuf_1 _2907_ (.A(\RF0.regs[0][23] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2908_ (.A(_1159_),
    ...
    .VPWR(VPWR),
    .X(_0736_));
 sky130_fd_sc_hd__clkbuf_1 _2909_ (.A(\RF0.regs[0][22] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2910_ (.A(_1160_),
    ...
    .VPWR(VPWR),
    .X(_0735_));
 sky130_fd_sc_hd__clkbuf_1 _2911_ (.A(\RF0.regs[0][21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2912_ (.A(_1161_),
    ...
    .VPWR(VPWR),
    .X(_0734_));
 sky130_fd_sc_hd__clkbuf_1 _2913_ (.A(\RF0.regs[0][20] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2916_ (.A(_1163_),
    ...
    .VPWR(VPWR),
    .X(_0732_));
 sky130_fd_sc_hd__clkbuf_1 _2917_ (.A(\RF0.regs[0][18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2918_ (.A(_1164_),
    ...
    .VPWR(VPWR),
    .X(_0731_));
 sky130_fd_sc_hd__clkbuf_1 _2919_ (.A(\RF0.regs[0][17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2920_ (.A(_1165_),
    ...
    .VPWR(VPWR),
    .X(_0730_));
 sky130_fd_sc_hd__clkbuf_1 _2921_ (.A(\RF0.regs[0][16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2922_ (.A(_1166_),
    ...
    .VPWR(VPWR),
    .X(_0729_));
 sky130_fd_sc_hd__clkbuf_1 _2923_ (.A(\RF0.regs[0][15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2924_ (.A(_1167_),
    ...
    .VPWR(VPWR),
    .X(_0728_));
 sky130_fd_sc_hd__clkbuf_1 _2925_ (.A(\RF0.regs[0][14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2926_ (.A(_1168_),
    ...
    .VPWR(VPWR),
    .X(_0727_));
 sky130_fd_sc_hd__clkbuf_1 _2927_ (.A(\RF0.regs[0][13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2928_ (.A(_1169_),
    ...
    .VPWR(VPWR),
    .X(_0726_));
 sky130_fd_sc_hd__clkbuf_1 _2929_ (.A(\RF0.regs[0][12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2930_ (.A(_1170_),
    ...
    .VPWR(VPWR),
    .X(_0725_));
 sky130_fd_sc_hd__clkbuf_1 _2931_ (.A(\RF0.regs[0][11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2932_ (.A(_1171_),
    ...
    .VPWR(VPWR),
    .X(_0724_));
 sky130_fd_sc_hd__clkbuf_1 _2933_ (.A(\RF0.regs[0][10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2934_ (.A(_1172_),
    ...
    .VPWR(VPWR),
    .X(_0723_));
 sky130_fd_sc_hd__clkbuf_1 _2935_ (.A(\RF0.regs[0][9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2936_ (.A(_1173_),
    ...
    .VPWR(VPWR),
    .X(_0722_));
 sky130_fd_sc_hd__clkbuf_1 _2937_ (.A(\RF0.regs[0][8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2938_ (.A(_1174_),
    ...
    .VPWR(VPWR),
    .X(_0721_));
 sky130_fd_sc_hd__clkbuf_1 _2939_ (.A(\RF0.regs[0][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2942_ (.A(_1176_),
    ...
    .VPWR(VPWR),
    .X(_0719_));
 sky130_fd_sc_hd__clkbuf_1 _2943_ (.A(\RF0.regs[0][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2944_ (.A(_1177_),
    ...
    .VPWR(VPWR),
    .X(_0718_));
 sky130_fd_sc_hd__clkbuf_1 _2945_ (.A(\RF0.regs[0][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2946_ (.A(_1178_),
    ...
    .VPWR(VPWR),
    .X(_0717_));
 sky130_fd_sc_hd__clkbuf_1 _2947_ (.A(\RF0.regs[0][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2948_ (.A(_1179_),
    ...
    .VPWR(VPWR),
    .X(_0716_));
 sky130_fd_sc_hd__clkbuf_1 _2949_ (.A(\RF0.regs[0][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2950_ (.A(_1180_),
    ...
    .VPWR(VPWR),
    .X(_0715_));
 sky130_fd_sc_hd__clkbuf_1 _2951_ (.A(\RF0.regs[0][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2952_ (.A(_1181_),
    ...
    .VPWR(VPWR),
    .X(_0714_));
 sky130_fd_sc_hd__clkbuf_1 _2953_ (.A(\RF0.regs[0][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2954_ (.A(_1182_),
    ...
    .VPWR(VPWR),
    .X(_0713_));
 sky130_fd_sc_hd__clkbuf_1 _2955_ (.A(\RF0.regs[2][31] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2956_ (.A(_1183_),
    ...
    .VPWR(VPWR),
    .X(_0712_));
 sky130_fd_sc_hd__clkbuf_1 _2957_ (.A(\RF0.regs[2][30] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2958_ (.A(_1184_),
    ...
    .VPWR(VPWR),
    .X(_0711_));
 sky130_fd_sc_hd__clkbuf_1 _2959_ (.A(\RF0.regs[2][29] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2960_ (.A(_1185_),
    ...
    .VPWR(VPWR),
    .X(_0710_));
 sky130_fd_sc_hd__clkbuf_1 _2961_ (.A(\RF0.regs[2][28] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2962_ (.A(_1186_),
    ...
    .VPWR(VPWR),
    .X(_0709_));
 sky130_fd_sc_hd__clkbuf_1 _2963_ (.A(\RF0.regs[2][27] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2964_ (.A(_1187_),
    ...
    .VPWR(VPWR),
    .X(_0708_));
 sky130_fd_sc_hd__clkbuf_1 _2965_ (.A(\RF0.regs[2][26] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2966_ (.A(_1188_),
    ...
    .VPWR(VPWR),
    .X(_0707_));
 sky130_fd_sc_hd__clkbuf_1 _2967_ (.A(\RF0.regs[2][25] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2968_ (.A(_1189_),
    ...
    .VPWR(VPWR),
    .X(_0706_));
 sky130_fd_sc_hd__clkbuf_1 _2969_ (.A(\RF0.regs[2][24] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2970_ (.A(_1190_),
    ...
    .VPWR(VPWR),
    .X(_0705_));
 sky130_fd_sc_hd__clkbuf_1 _2971_ (.A(\RF0.regs[2][23] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2972_ (.A(_1191_),
    ...
    .VPWR(VPWR),
    .X(_0704_));
 sky130_fd_sc_hd__clkbuf_1 _2973_ (.A(\RF0.regs[2][22] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2974_ (.A(_1192_),
    ...
    .VPWR(VPWR),
    .X(_0703_));
 sky130_fd_sc_hd__clkbuf_1 _2975_ (.A(\RF0.regs[2][21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2976_ (.A(_1193_),
    ...
    .VPWR(VPWR),
    .X(_0702_));
 sky130_fd_sc_hd__clkbuf_1 _2977_ (.A(\RF0.regs[2][20] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2978_ (.A(_1194_),
    ...
    .VPWR(VPWR),
    .X(_0701_));
 sky130_fd_sc_hd__clkbuf_1 _2979_ (.A(\RF0.regs[2][19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2980_ (.A(_1195_),
    ...
    .VPWR(VPWR),
    .X(_0700_));
 sky130_fd_sc_hd__clkbuf_1 _2981_ (.A(\RF0.regs[2][18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2982_ (.A(_1196_),
    ...
    .VPWR(VPWR),
    .X(_0699_));
 sky130_fd_sc_hd__clkbuf_1 _2983_ (.A(\RF0.regs[2][17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2984_ (.A(_1197_),
    ...
    .VPWR(VPWR),
    .X(_0698_));
 sky130_fd_sc_hd__clkbuf_1 _2985_ (.A(\RF0.regs[2][16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2986_ (.A(_1198_),
    ...
    .VPWR(VPWR),
    .X(_0697_));
 sky130_fd_sc_hd__clkbuf_1 _2987_ (.A(\RF0.regs[2][15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2988_ (.A(_1199_),
    ...
    .VPWR(VPWR),
    .X(_0696_));
 sky130_fd_sc_hd__clkbuf_1 _2989_ (.A(\RF0.regs[2][14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2990_ (.A(_1200_),
    ...
    .VPWR(VPWR),
    .X(_0695_));
 sky130_fd_sc_hd__clkbuf_1 _2991_ (.A(\RF0.regs[2][13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2992_ (.A(_1201_),
    ...
    .VPWR(VPWR),
    .X(_0694_));
 sky130_fd_sc_hd__clkbuf_1 _2993_ (.A(\RF0.regs[2][12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2994_ (.A(_1202_),
    ...
    .VPWR(VPWR),
    .X(_0693_));
 sky130_fd_sc_hd__clkbuf_1 _2995_ (.A(\RF0.regs[2][11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2996_ (.A(_1203_),
    ...
    .VPWR(VPWR),
    .X(_0692_));
 sky130_fd_sc_hd__clkbuf_1 _2997_ (.A(\RF0.regs[2][10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _2998_ (.A(_1204_),
    ...
    .VPWR(VPWR),
    .X(_0691_));
 sky130_fd_sc_hd__clkbuf_1 _2999_ (.A(\RF0.regs[2][9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3000_ (.A(_1205_),
    ...
    .VPWR(VPWR),
    .X(_0690_));
 sky130_fd_sc_hd__clkbuf_1 _3001_ (.A(\RF0.regs[2][8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3002_ (.A(_1206_),
    ...
    .VPWR(VPWR),
    .X(_0689_));
 sky130_fd_sc_hd__clkbuf_1 _3003_ (.A(\RF0.regs[2][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3004_ (.A(_1207_),
    ...
    .VPWR(VPWR),
    .X(_0688_));
 sky130_fd_sc_hd__clkbuf_1 _3005_ (.A(\RF0.regs[2][6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3006_ (.A(_1208_),
    ...
    .VPWR(VPWR),
    .X(_0687_));
 sky130_fd_sc_hd__clkbuf_1 _3007_ (.A(\RF0.regs[2][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3010_ (.A(_1210_),
    ...
    .VPWR(VPWR),
    .X(_0685_));
 sky130_fd_sc_hd__clkbuf_1 _3011_ (.A(\RF0.regs[2][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3014_ (.A(_1212_),
    ...
    .VPWR(VPWR),
    .X(_0683_));
 sky130_fd_sc_hd__clkbuf_1 _3015_ (.A(\RF0.regs[2][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _3016_ (.A(_1213_),
    ...
    .VPWR(VPWR),
    .X(_0682_));
 sky130_fd_sc_hd__clkbuf_1 _3017_ (.A(\RF0.regs[2][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a221o_1 _3060_ (.A1(\RF0.regs[25][30] ),
    ...
    .VPWR(VPWR),
    .X(_1256_));
 sky130_fd_sc_hd__clkbuf_4 _3061_ (.A(_0825_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a221o_1 _3080_ (.A1(\RF0.regs[10][7] ),
    ...
    .VPWR(VPWR),
    .X(_1276_));
 sky130_fd_sc_hd__or2_1 _3081_ (.A(_0818_),
    .B(_0825_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3_1 _3089_ (.A(_1078_),
    ...
    .VPWR(VPWR),
    .X(_1285_));
 sky130_fd_sc_hd__o21a_1 _3090_ (.A1(_1263_),
    .A2(_1285_),
    .B1(_1281_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _3094_ (.A1(_0825_),
    ...
    .VPWR(VPWR),
    .Y(_1290_));
 sky130_fd_sc_hd__or4b_2 _3095_ (.A(_1278_),
    .B(_1282_),
    .C(_1286_),
    .D_N(_1290_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3096_ (.A(_1263_),
    ...
    .VPWR(VPWR),
    .Y(_1292_));
 sky130_fd_sc_hd__a211o_1 _3097_ (.A1(_0825_),
    .A2(_0950_),
    .B1(_1291_),
    .C1(_1292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1293_));
 sky130_fd_sc_hd__and2_1 _3098_ (.A(_0825_),
    .B(_0944_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1294_));
 sky130_fd_sc_hd__a211oi_4 _3099_ (.A1(_0825_),
    .A2(_1276_),
    .B1(_1293_),
    .C1(_1294_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _3102_ (.A(_1257_),
    ...
    .VPWR(VPWR),
    .X(_1298_));
 sky130_fd_sc_hd__nor3_1 _3103_ (.A(_1273_),
    .B(_1297_),
    .C(_1298_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1299_));
 sky130_fd_sc_hd__or3b_2 _3104_ (.A(_1266_),
    .B(_1269_),
    .C_N(net46),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _3121_ (.A1(_1062_),
    ...
    .VPWR(VPWR),
    .X(_1317_));
 sky130_fd_sc_hd__or3_2 _3122_ (.A(_1312_),
    .B(_1315_),
    .C(_1317_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _3127_ (.A(_1264_),
    ...
    .VPWR(VPWR),
    .X(_1323_));
 sky130_fd_sc_hd__or3b_2 _3128_ (.A(_1318_),
    .B(_1322_),
    .C_N(_1323_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _3160_ (.A(_1353_),
    ...
    .VPWR(VPWR),
    .X(_1356_));
 sky130_fd_sc_hd__nor2_1 _3161_ (.A(_1318_),
    .B(_1322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _3164_ (.A(_1359_),
    ...
    .VPWR(VPWR),
    .Y(_1360_));
 sky130_fd_sc_hd__nand2_1 _3165_ (.A(net46),
    .B(_1267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1361_));
 sky130_fd_sc_hd__o211a_1 _3166_ (.A1(net46),
    .A2(_1267_),
    .B1(_1361_),
    .C1(_0841_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _3170_ (.A(_1220_),
    ...
    .VPWR(VPWR),
    .X(_1366_));
 sky130_fd_sc_hd__mux2_1 _3171_ (.A0(_1365_),
    .A1(_1366_),
    .S(_1300_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1367_));
 sky130_fd_sc_hd__xor2_1 _3172_ (.A(_0926_),
    .B(_1367_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1368_));
 sky130_fd_sc_hd__and3_1 _3173_ (.A(net46),
    .B(_1267_),
    .C(_1268_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3184_ (.A(_1377_),
    ...
    .VPWR(VPWR),
    .Y(_1380_));
 sky130_fd_sc_hd__nand2_1 _3185_ (.A(_1377_),
    .B(_1379_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _3187_ (.A1(_1291_),
    ...
    .VPWR(VPWR),
    .Y(_1383_));
 sky130_fd_sc_hd__and3_1 _3188_ (.A(_0825_),
    .B(_1293_),
    .C(_1383_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a311o_1 _3263_ (.A1(_1442_),
    ...
    .VPWR(VPWR),
    .X(_1459_));
 sky130_fd_sc_hd__a21o_1 _3264_ (.A1(_1439_),
    .A2(_1454_),
    .B1(_1459_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _3292_ (.A(_1487_),
    ...
    .VPWR(VPWR),
    .Y(_1488_));
 sky130_fd_sc_hd__a21bo_1 _3293_ (.A1(_1304_),
    .A2(_1307_),
    .B1_N(_1265_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a311o_1 _3304_ (.A1(_1480_),
    ...
    .VPWR(VPWR),
    .X(_1500_));
 sky130_fd_sc_hd__a21oi_1 _3305_ (.A1(_1475_),
    .A2(_1496_),
    .B1(_1500_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3306_ (.A(_1252_),
    ...
    .VPWR(VPWR),
    .Y(_1502_));
 sky130_fd_sc_hd__mux2_1 _3307_ (.A0(_1322_),
    .A1(_1502_),
    .S(_1318_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1503_));
 sky130_fd_sc_hd__xnor2_1 _3308_ (.A(_1089_),
    .B(_1503_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_1 _3311_ (.A1(_1312_),
    ...
    .VPWR(VPWR),
    .Y(_1507_));
 sky130_fd_sc_hd__nand2_1 _3312_ (.A(_1318_),
    .B(_1507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3313_ (.A(_1506_),
    ...
    .VPWR(VPWR),
    .Y(_1509_));
 sky130_fd_sc_hd__nor2_1 _3314_ (.A(_1308_),
    .B(_1310_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3317_ (.A(_1221_),
    ...
    .VPWR(VPWR),
    .Y(_1513_));
 sky130_fd_sc_hd__mux2_1 _3318_ (.A0(_1315_),
    .A1(_1513_),
    .S(_1312_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _3320_ (.A(_1512_),
    ...
    .VPWR(VPWR),
    .X(_1516_));
 sky130_fd_sc_hd__or4_1 _3321_ (.A(_1501_),
    .B(_1504_),
    .C(_1509_),
    .D(_1516_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _3328_ (.A(_1518_),
    ...
    .VPWR(VPWR),
    .X(_1524_));
 sky130_fd_sc_hd__and2_1 _3329_ (.A(_1318_),
    .B(_1507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3337_ (.A(_1004_),
    ...
    .VPWR(VPWR),
    .Y(_1533_));
 sky130_fd_sc_hd__a211o_1 _3338_ (.A1(_1517_),
    .A2(_1532_),
    .B1(_1533_),
    .C1(_1359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _3343_ (.A(_0999_),
    ...
    .VPWR(VPWR),
    .X(_1539_));
 sky130_fd_sc_hd__a31oi_4 _3344_ (.A1(_1360_),
    .A2(_1534_),
    .A3(_1538_),
    .B1(_1539_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3348_ (.A(_0966_),
    ...
    .VPWR(VPWR),
    .Y(_1544_));
 sky130_fd_sc_hd__a211o_1 _3349_ (.A1(_1352_),
    .A2(_1542_),
    .B1(_1543_),
    .C1(_1544_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3351_ (.A(_0892_),
    ...
    .VPWR(VPWR),
    .Y(_1547_));
 sky130_fd_sc_hd__a211o_1 _3352_ (.A1(_1347_),
    .A2(_1545_),
    .B1(_1546_),
    .C1(_1547_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3353_ (.A(_1256_),
    ...
    .VPWR(VPWR),
    .Y(_1549_));
 sky130_fd_sc_hd__a21o_1 _3354_ (.A1(_1345_),
    .A2(_1548_),
    .B1(_1549_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _3357_ (.A(_1013_),
    ...
    .VPWR(VPWR),
    .Y(_1553_));
 sky130_fd_sc_hd__a21oi_1 _3358_ (.A1(_1342_),
    .A2(_1550_),
    .B1(_1553_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _3550_ (.A1(_1465_),
    ...
    .VPWR(VPWR),
    .Y(_1742_));
 sky130_fd_sc_hd__nor2_1 _3551_ (.A(_1368_),
    .B(_1742_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1743_));
 sky130_fd_sc_hd__and2_1 _3552_ (.A(_1368_),
    .B(_1742_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _3601_ (.A1(_0972_),
    ...
    .VPWR(VPWR),
    .X(_1792_));
 sky130_fd_sc_hd__xnor2_1 _3602_ (.A(_1442_),
    .B(_1792_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31a_2 _3728_ (.A1(_1805_),
    ...
    .VPWR(VPWR),
    .X(_1914_));
 sky130_fd_sc_hd__o21ai_1 _3729_ (.A1(_1442_),
    .A2(_1792_),
    .B1(_1009_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _3730_ (.A(_1787_),
    ...
    .VPWR(VPWR),
    .Y(_1916_));
 sky130_fd_sc_hd__a211o_1 _3731_ (.A1(_1442_),
    .A2(_1792_),
    .B1(_1915_),
    .C1(_1916_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _3746_ (.A1(_1641_),
    ...
    .VPWR(VPWR),
    .X(_1932_));
 sky130_fd_sc_hd__o221a_1 _3747_ (.A1(_1675_),
    .A2(_1928_),
    .B1(_1930_),
    .B2(_1652_),
    .C1(_1932_),
 ...
 sky130_fd_sc_hd__or2b_2 _3871_ (.A(_1893_),
    ...
    .VPWR(VPWR),
    .X(_2037_));
 sky130_fd_sc_hd__mux2_1 _3872_ (.A0(_0820_),
    .A1(_0957_),
    .S(_1258_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4015_ (.A(_2135_),
    ...
    .VPWR(VPWR),
    .X(_0618_));
 sky130_fd_sc_hd__clkbuf_1 _4016_ (.A(\RF0.regs[5][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4092_ (.A(_2178_),
    ...
    .VPWR(VPWR),
    .X(_0585_));
 sky130_fd_sc_hd__clkbuf_1 _4093_ (.A(\RF0.regs[7][31] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4094_ (.A(_2179_),
    ...
    .VPWR(VPWR),
    .X(_0584_));
 sky130_fd_sc_hd__clkbuf_1 _4095_ (.A(\RF0.regs[7][30] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4096_ (.A(_2180_),
    ...
    .VPWR(VPWR),
    .X(_0583_));
 sky130_fd_sc_hd__clkbuf_1 _4097_ (.A(\RF0.regs[7][29] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4098_ (.A(_2181_),
    ...
    .VPWR(VPWR),
    .X(_0582_));
 sky130_fd_sc_hd__clkbuf_1 _4099_ (.A(\RF0.regs[7][28] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4100_ (.A(_2182_),
    ...
    .VPWR(VPWR),
    .X(_0581_));
 sky130_fd_sc_hd__clkbuf_1 _4101_ (.A(\RF0.regs[7][27] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4102_ (.A(_2183_),
    ...
    .VPWR(VPWR),
    .X(_0580_));
 sky130_fd_sc_hd__clkbuf_1 _4103_ (.A(\RF0.regs[7][26] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4104_ (.A(_2184_),
    ...
    .VPWR(VPWR),
    .X(_0579_));
 sky130_fd_sc_hd__clkbuf_1 _4105_ (.A(\RF0.regs[7][25] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4106_ (.A(_2185_),
    ...
    .VPWR(VPWR),
    .X(_0578_));
 sky130_fd_sc_hd__clkbuf_1 _4107_ (.A(\RF0.regs[7][24] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4108_ (.A(_2186_),
    ...
    .VPWR(VPWR),
    .X(_0577_));
 sky130_fd_sc_hd__clkbuf_1 _4109_ (.A(\RF0.regs[7][23] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4110_ (.A(_2187_),
    ...
    .VPWR(VPWR),
    .X(_0576_));
 sky130_fd_sc_hd__clkbuf_1 _4111_ (.A(\RF0.regs[7][22] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4112_ (.A(_2188_),
    ...
    .VPWR(VPWR),
    .X(_0575_));
 sky130_fd_sc_hd__clkbuf_1 _4113_ (.A(\RF0.regs[7][21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4114_ (.A(_2189_),
    ...
    .VPWR(VPWR),
    .X(_0574_));
 sky130_fd_sc_hd__clkbuf_1 _4115_ (.A(\RF0.regs[7][20] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4116_ (.A(_2190_),
    ...
    .VPWR(VPWR),
    .X(_0573_));
 sky130_fd_sc_hd__clkbuf_1 _4117_ (.A(\RF0.regs[7][19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4118_ (.A(_2191_),
    ...
    .VPWR(VPWR),
    .X(_0572_));
 sky130_fd_sc_hd__clkbuf_1 _4119_ (.A(\RF0.regs[7][18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4120_ (.A(_2192_),
    ...
    .VPWR(VPWR),
    .X(_0571_));
 sky130_fd_sc_hd__clkbuf_1 _4121_ (.A(\RF0.regs[7][17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4122_ (.A(_2193_),
    ...
    .VPWR(VPWR),
    .X(_0570_));
 sky130_fd_sc_hd__clkbuf_1 _4123_ (.A(\RF0.regs[7][16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4124_ (.A(_2194_),
    ...
    .VPWR(VPWR),
    .X(_0569_));
 sky130_fd_sc_hd__clkbuf_1 _4125_ (.A(\RF0.regs[7][15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4126_ (.A(_2195_),
    ...
    .VPWR(VPWR),
    .X(_0568_));
 sky130_fd_sc_hd__clkbuf_1 _4127_ (.A(\RF0.regs[7][14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4128_ (.A(_2196_),
    ...
    .VPWR(VPWR),
    .X(_0567_));
 sky130_fd_sc_hd__clkbuf_1 _4129_ (.A(\RF0.regs[7][13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4130_ (.A(_2197_),
    ...
    .VPWR(VPWR),
    .X(_0566_));
 sky130_fd_sc_hd__clkbuf_1 _4131_ (.A(\RF0.regs[7][12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4132_ (.A(_2198_),
    ...
    .VPWR(VPWR),
    .X(_0565_));
 sky130_fd_sc_hd__clkbuf_1 _4133_ (.A(\RF0.regs[7][11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4134_ (.A(_2199_),
    ...
    .VPWR(VPWR),
    .X(_0564_));
 sky130_fd_sc_hd__clkbuf_1 _4135_ (.A(\RF0.regs[7][10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4136_ (.A(_2200_),
    ...
    .VPWR(VPWR),
    .X(_0563_));
 sky130_fd_sc_hd__clkbuf_1 _4137_ (.A(\RF0.regs[7][9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4138_ (.A(_2201_),
    ...
    .VPWR(VPWR),
    .X(_0562_));
 sky130_fd_sc_hd__clkbuf_1 _4139_ (.A(\RF0.regs[7][8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4140_ (.A(_2202_),
    ...
    .VPWR(VPWR),
    .X(_0561_));
 sky130_fd_sc_hd__clkbuf_1 _4141_ (.A(\RF0.regs[7][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4142_ (.A(_2203_),
    ...
    .VPWR(VPWR),
    .X(_0560_));
 sky130_fd_sc_hd__clkbuf_1 _4143_ (.A(\RF0.regs[7][6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4144_ (.A(_2204_),
    ...
    .VPWR(VPWR),
    .X(_0559_));
 sky130_fd_sc_hd__clkbuf_1 _4145_ (.A(\RF0.regs[7][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4146_ (.A(_2205_),
    ...
    .VPWR(VPWR),
    .X(_0558_));
 sky130_fd_sc_hd__clkbuf_1 _4147_ (.A(\RF0.regs[7][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4148_ (.A(_2206_),
    ...
    .VPWR(VPWR),
    .X(_0557_));
 sky130_fd_sc_hd__clkbuf_1 _4149_ (.A(\RF0.regs[7][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4150_ (.A(_2207_),
    ...
    .VPWR(VPWR),
    .X(_0556_));
 sky130_fd_sc_hd__clkbuf_1 _4151_ (.A(\RF0.regs[7][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4152_ (.A(_2208_),
    ...
    .VPWR(VPWR),
    .X(_0555_));
 sky130_fd_sc_hd__clkbuf_1 _4153_ (.A(\RF0.regs[7][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4154_ (.A(_2209_),
    ...
    .VPWR(VPWR),
    .X(_0554_));
 sky130_fd_sc_hd__clkbuf_1 _4155_ (.A(\RF0.regs[7][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 _4199_ (.A(_0909_),
    ...
    .VPWR(VPWR),
    .X(_2233_));
 sky130_fd_sc_hd__mux2_1 _4200_ (.A0(\RF0.regs[10][11] ),
    .A1(_2072_),
    .S(_2233_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4223_ (.A(_2245_),
    ...
    .VPWR(VPWR),
    .X(_0521_));
 sky130_fd_sc_hd__clkbuf_1 _4224_ (.A(\RF0.regs[12][31] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4225_ (.A(_2246_),
    ...
    .VPWR(VPWR),
    .X(_0520_));
 sky130_fd_sc_hd__clkbuf_1 _4226_ (.A(\RF0.regs[12][30] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4227_ (.A(_2247_),
    ...
    .VPWR(VPWR),
    .X(_0519_));
 sky130_fd_sc_hd__clkbuf_1 _4228_ (.A(\RF0.regs[12][29] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4229_ (.A(_2248_),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__clkbuf_1 _4230_ (.A(\RF0.regs[12][28] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4231_ (.A(_2249_),
    ...
    .VPWR(VPWR),
    .X(_0517_));
 sky130_fd_sc_hd__clkbuf_1 _4232_ (.A(\RF0.regs[12][27] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4233_ (.A(_2250_),
    ...
    .VPWR(VPWR),
    .X(_0516_));
 sky130_fd_sc_hd__clkbuf_1 _4234_ (.A(\RF0.regs[12][26] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4235_ (.A(_2251_),
    ...
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__clkbuf_1 _4236_ (.A(\RF0.regs[12][25] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4237_ (.A(_2252_),
    ...
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__clkbuf_1 _4238_ (.A(\RF0.regs[12][24] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4239_ (.A(_2253_),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__clkbuf_1 _4240_ (.A(\RF0.regs[12][23] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4243_ (.A(_2255_),
    ...
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__clkbuf_1 _4244_ (.A(\RF0.regs[12][21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4245_ (.A(_2256_),
    ...
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__clkbuf_1 _4246_ (.A(\RF0.regs[12][20] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4249_ (.A(_2258_),
    ...
    .VPWR(VPWR),
    .X(_0508_));
 sky130_fd_sc_hd__clkbuf_1 _4250_ (.A(\RF0.regs[12][18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4255_ (.A(_2261_),
    ...
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__clkbuf_1 _4256_ (.A(\RF0.regs[12][15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4257_ (.A(_2262_),
    ...
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__clkbuf_1 _4258_ (.A(\RF0.regs[12][14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4259_ (.A(_2263_),
    ...
    .VPWR(VPWR),
    .X(_0503_));
 sky130_fd_sc_hd__clkbuf_1 _4260_ (.A(\RF0.regs[12][13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4261_ (.A(_2264_),
    ...
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__clkbuf_1 _4262_ (.A(\RF0.regs[12][12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4263_ (.A(_2265_),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__clkbuf_1 _4264_ (.A(\RF0.regs[12][11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4265_ (.A(_2266_),
    ...
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__clkbuf_1 _4266_ (.A(\RF0.regs[12][10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4267_ (.A(_2267_),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__clkbuf_1 _4268_ (.A(\RF0.regs[12][9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4269_ (.A(_2268_),
    ...
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__clkbuf_1 _4270_ (.A(\RF0.regs[12][8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4271_ (.A(_2269_),
    ...
    .VPWR(VPWR),
    .X(_0497_));
 sky130_fd_sc_hd__clkbuf_1 _4272_ (.A(\RF0.regs[12][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4273_ (.A(_2270_),
    ...
    .VPWR(VPWR),
    .X(_0496_));
 sky130_fd_sc_hd__clkbuf_1 _4274_ (.A(\RF0.regs[12][6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4275_ (.A(_2271_),
    ...
    .VPWR(VPWR),
    .X(_0495_));
 sky130_fd_sc_hd__clkbuf_1 _4276_ (.A(\RF0.regs[12][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4277_ (.A(_2272_),
    ...
    .VPWR(VPWR),
    .X(_0494_));
 sky130_fd_sc_hd__clkbuf_1 _4278_ (.A(\RF0.regs[12][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4281_ (.A(_2274_),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__clkbuf_1 _4282_ (.A(\RF0.regs[12][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4283_ (.A(_2275_),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__clkbuf_1 _4284_ (.A(\RF0.regs[12][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 _4356_ (.A(_1225_),
    ...
    .VPWR(VPWR),
    .X(_2314_));
 sky130_fd_sc_hd__mux2_1 _4357_ (.A0(\RF0.regs[20][31] ),
    .A1(_1952_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4358_ (.A(_2315_),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__mux2_1 _4359_ (.A0(\RF0.regs[20][30] ),
    .A1(_1957_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4360_ (.A(_2316_),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__mux2_1 _4361_ (.A0(\RF0.regs[20][29] ),
    .A1(_1962_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4362_ (.A(_2317_),
    ...
    .VPWR(VPWR),
    .X(_0454_));
 sky130_fd_sc_hd__mux2_1 _4363_ (.A0(\RF0.regs[20][28] ),
    .A1(_1965_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4364_ (.A(_2318_),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__mux2_1 _4365_ (.A0(\RF0.regs[20][27] ),
    .A1(_1971_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4366_ (.A(_2319_),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__mux2_1 _4367_ (.A0(\RF0.regs[20][26] ),
    .A1(_1975_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4368_ (.A(_2320_),
    ...
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__mux2_1 _4369_ (.A0(\RF0.regs[20][25] ),
    .A1(_1978_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4370_ (.A(_2321_),
    ...
    .VPWR(VPWR),
    .X(_0450_));
 sky130_fd_sc_hd__mux2_1 _4371_ (.A0(\RF0.regs[20][24] ),
    .A1(_1981_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4372_ (.A(_2322_),
    ...
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__mux2_1 _4373_ (.A0(\RF0.regs[20][23] ),
    .A1(_1986_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4374_ (.A(_2323_),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__mux2_1 _4375_ (.A0(\RF0.regs[20][22] ),
    .A1(_1988_),
    .S(_2314_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_4 _4377_ (.A(_1225_),
    ...
    .VPWR(VPWR),
    .X(_2325_));
 sky130_fd_sc_hd__mux2_1 _4378_ (.A0(\RF0.regs[20][21] ),
    .A1(_1992_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4381_ (.A(_2327_),
    ...
    .VPWR(VPWR),
    .X(_0445_));
 sky130_fd_sc_hd__mux2_1 _4382_ (.A0(\RF0.regs[20][19] ),
    .A1(_2000_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4383_ (.A(_2328_),
    ...
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__mux2_1 _4384_ (.A0(\RF0.regs[20][18] ),
    .A1(_2002_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4385_ (.A(_2329_),
    ...
    .VPWR(VPWR),
    .X(_0443_));
 sky130_fd_sc_hd__mux2_1 _4386_ (.A0(\RF0.regs[20][17] ),
    .A1(_2005_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4387_ (.A(_2330_),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__mux2_1 _4388_ (.A0(\RF0.regs[20][16] ),
    .A1(_2008_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4389_ (.A(_2331_),
    ...
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__mux2_1 _4390_ (.A0(\RF0.regs[20][15] ),
    .A1(_2012_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4391_ (.A(_2332_),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__mux2_1 _4392_ (.A0(\RF0.regs[20][14] ),
    .A1(_2063_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4393_ (.A(_2333_),
    ...
    .VPWR(VPWR),
    .X(_0439_));
 sky130_fd_sc_hd__mux2_1 _4394_ (.A0(\RF0.regs[20][13] ),
    .A1(_2066_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4395_ (.A(_2334_),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__mux2_1 _4396_ (.A0(\RF0.regs[20][12] ),
    .A1(_2069_),
    .S(_2325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_4 _4398_ (.A(_1225_),
    ...
    .VPWR(VPWR),
    .X(_2336_));
 sky130_fd_sc_hd__mux2_1 _4399_ (.A0(\RF0.regs[20][11] ),
    .A1(_2072_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4400_ (.A(_2337_),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__mux2_1 _4401_ (.A0(\RF0.regs[20][10] ),
    .A1(_2077_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4402_ (.A(_2338_),
    ...
    .VPWR(VPWR),
    .X(_0435_));
 sky130_fd_sc_hd__mux2_1 _4403_ (.A0(\RF0.regs[20][9] ),
    .A1(_2080_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4404_ (.A(_2339_),
    ...
    .VPWR(VPWR),
    .X(_0434_));
 sky130_fd_sc_hd__mux2_1 _4405_ (.A0(\RF0.regs[20][8] ),
    .A1(_2083_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4406_ (.A(_2340_),
    ...
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__mux2_1 _4407_ (.A0(\RF0.regs[20][7] ),
    .A1(_2086_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4408_ (.A(_2341_),
    ...
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__mux2_1 _4409_ (.A0(\RF0.regs[20][6] ),
    .A1(_2088_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4410_ (.A(_2342_),
    ...
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__mux2_1 _4411_ (.A0(\RF0.regs[20][5] ),
    .A1(_2090_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4412_ (.A(_2343_),
    ...
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__mux2_1 _4413_ (.A0(\RF0.regs[20][4] ),
    .A1(_2092_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4414_ (.A(_2344_),
    ...
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__mux2_1 _4415_ (.A0(\RF0.regs[20][3] ),
    .A1(_2094_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4416_ (.A(_2345_),
    ...
    .VPWR(VPWR),
    .X(_0428_));
 sky130_fd_sc_hd__mux2_1 _4417_ (.A0(\RF0.regs[20][2] ),
    .A1(_2097_),
    .S(_2336_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4418_ (.A(_2346_),
    ...
    .VPWR(VPWR),
    .X(_0427_));
 sky130_fd_sc_hd__mux2_1 _4419_ (.A0(\RF0.regs[20][1] ),
    .A1(_2099_),
    .S(_1225_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4420_ (.A(_2347_),
    ...
    .VPWR(VPWR),
    .X(_0426_));
 sky130_fd_sc_hd__mux2_1 _4421_ (.A0(\RF0.regs[20][0] ),
    .A1(_2177_),
    .S(_1225_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _4489_ (.A(_2383_),
    ...
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__nor2_1 _4490_ (.A(\disp.digit_select[0] ),
 ...
 sky130_fd_sc_hd__nor2_1 _4565_ (.A(_0799_),
    ...
    .VPWR(VPWR),
    .Y(net21));
 sky130_fd_sc_hd__and3_1 _4566_ (.A(_1149_),
    .B(_1548_),
    .C(_1571_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5113_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[12][0] ));
 sky130_fd_sc_hd__dfrtp_1 _5114_ (.CLK(clk),
    .D(_0490_),
    .RESET_B(_0106_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5153_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[10][8] ));
 sky130_fd_sc_hd__dfrtp_4 _5154_ (.CLK(clk),
    .D(_0530_),
    .RESET_B(_0146_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _5165_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[10][20] ));
 sky130_fd_sc_hd__dfrtp_4 _5166_ (.CLK(clk),
    .D(_0542_),
    .RESET_B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5167_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[10][22] ));
 sky130_fd_sc_hd__dfrtp_4 _5168_ (.CLK(clk),
    .D(_0544_),
    .RESET_B(_0160_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5272_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[5][31] ));
 sky130_fd_sc_hd__dfrtp_4 _5273_ (.CLK(clk),
    .D(_0649_),
    .RESET_B(_0265_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5281_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[4][8] ));
 sky130_fd_sc_hd__dfrtp_4 _5282_ (.CLK(clk),
    .D(_0658_),
    .RESET_B(_0274_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _5286_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[4][13] ));
 sky130_fd_sc_hd__dfrtp_4 _5287_ (.CLK(clk),
    .D(_0663_),
    .RESET_B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _5290_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[4][17] ));
 sky130_fd_sc_hd__dfrtp_4 _5291_ (.CLK(clk),
    .D(_0667_),
    .RESET_B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _5300_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[4][27] ));
 sky130_fd_sc_hd__dfrtp_1 _5301_ (.CLK(clk),
    .D(_0677_),
    .RESET_B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[4][28] ));
 sky130_fd_sc_hd__dfrtp_1 _5302_ (.CLK(clk),
    .D(_0678_),
    .RESET_B(_0294_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5304_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[4][31] ));
 sky130_fd_sc_hd__dfrtp_1 _5305_ (.CLK(clk),
    .D(_0681_),
    .RESET_B(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][0] ));
 sky130_fd_sc_hd__dfrtp_1 _5306_ (.CLK(clk),
    .D(_0682_),
    .RESET_B(_0298_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][1] ));
 sky130_fd_sc_hd__dfrtp_1 _5307_ (.CLK(clk),
    .D(_0683_),
    .RESET_B(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][2] ));
 sky130_fd_sc_hd__dfrtp_1 _5308_ (.CLK(clk),
    .D(_0684_),
    .RESET_B(_0300_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][3] ));
 sky130_fd_sc_hd__dfrtp_1 _5309_ (.CLK(clk),
    .D(_0685_),
    .RESET_B(_0301_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][4] ));
 sky130_fd_sc_hd__dfrtp_1 _5310_ (.CLK(clk),
    .D(_0686_),
    .RESET_B(_0302_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5311_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][6] ));
 sky130_fd_sc_hd__dfrtp_1 _5312_ (.CLK(clk),
    .D(_0688_),
    .RESET_B(_0304_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5313_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][8] ));
 sky130_fd_sc_hd__dfrtp_1 _5314_ (.CLK(clk),
    .D(_0690_),
    .RESET_B(_0306_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5315_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][10] ));
 sky130_fd_sc_hd__dfrtp_1 _5316_ (.CLK(clk),
    .D(_0692_),
    .RESET_B(_0308_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5318_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][13] ));
 sky130_fd_sc_hd__dfrtp_1 _5319_ (.CLK(clk),
    .D(_0695_),
    .RESET_B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][14] ));
 sky130_fd_sc_hd__dfrtp_1 _5320_ (.CLK(clk),
    .D(_0696_),
    .RESET_B(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][15] ));
 sky130_fd_sc_hd__dfrtp_1 _5321_ (.CLK(clk),
    .D(_0697_),
    .RESET_B(_0313_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][16] ));
 sky130_fd_sc_hd__dfrtp_1 _5322_ (.CLK(clk),
    .D(_0698_),
    .RESET_B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][17] ));
 sky130_fd_sc_hd__dfrtp_1 _5323_ (.CLK(clk),
    .D(_0699_),
    .RESET_B(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][18] ));
 sky130_fd_sc_hd__dfrtp_1 _5324_ (.CLK(clk),
    .D(_0700_),
    .RESET_B(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][19] ));
 sky130_fd_sc_hd__dfrtp_1 _5325_ (.CLK(clk),
    .D(_0701_),
    .RESET_B(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][20] ));
 sky130_fd_sc_hd__dfrtp_1 _5326_ (.CLK(clk),
    .D(_0702_),
    .RESET_B(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][21] ));
 sky130_fd_sc_hd__dfrtp_1 _5327_ (.CLK(clk),
    .D(_0703_),
    .RESET_B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][22] ));
 sky130_fd_sc_hd__dfrtp_1 _5328_ (.CLK(clk),
    .D(_0704_),
    .RESET_B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][23] ));
 sky130_fd_sc_hd__dfrtp_1 _5329_ (.CLK(clk),
    .D(_0705_),
    .RESET_B(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][24] ));
 sky130_fd_sc_hd__dfrtp_1 _5330_ (.CLK(clk),
    .D(_0706_),
    .RESET_B(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][25] ));
 sky130_fd_sc_hd__dfrtp_1 _5331_ (.CLK(clk),
    .D(_0707_),
    .RESET_B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][26] ));
 sky130_fd_sc_hd__dfrtp_1 _5332_ (.CLK(clk),
    .D(_0708_),
    .RESET_B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5333_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][28] ));
 sky130_fd_sc_hd__dfrtp_1 _5334_ (.CLK(clk),
    .D(_0710_),
    .RESET_B(_0326_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5335_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][30] ));
 sky130_fd_sc_hd__dfrtp_1 _5336_ (.CLK(clk),
    .D(_0712_),
    .RESET_B(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[2][31] ));
 sky130_fd_sc_hd__dfrtp_1 _5337_ (.CLK(clk),
    .D(_0713_),
    .RESET_B(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][0] ));
 sky130_fd_sc_hd__dfrtp_1 _5338_ (.CLK(clk),
    .D(_0714_),
    .RESET_B(_0330_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _5339_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][2] ));
 sky130_fd_sc_hd__dfrtp_1 _5340_ (.CLK(clk),
    .D(_0716_),
    .RESET_B(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][3] ));
 sky130_fd_sc_hd__dfrtp_1 _5341_ (.CLK(clk),
    .D(_0717_),
    .RESET_B(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][4] ));
 sky130_fd_sc_hd__dfrtp_1 _5342_ (.CLK(clk),
    .D(_0718_),
    .RESET_B(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][5] ));
 sky130_fd_sc_hd__dfrtp_1 _5343_ (.CLK(clk),
    .D(_0719_),
    .RESET_B(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][6] ));
 sky130_fd_sc_hd__dfrtp_1 _5344_ (.CLK(clk),
    .D(_0720_),
    .RESET_B(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][7] ));
 sky130_fd_sc_hd__dfrtp_1 _5345_ (.CLK(clk),
    .D(_0721_),
    .RESET_B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][8] ));
 sky130_fd_sc_hd__dfrtp_1 _5346_ (.CLK(clk),
    .D(_0722_),
    .RESET_B(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][9] ));
 sky130_fd_sc_hd__dfrtp_1 _5347_ (.CLK(clk),
    .D(_0723_),
    .RESET_B(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][10] ));
 sky130_fd_sc_hd__dfrtp_1 _5348_ (.CLK(clk),
    .D(_0724_),
    .RESET_B(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][11] ));
 sky130_fd_sc_hd__dfrtp_1 _5349_ (.CLK(clk),
    .D(_0725_),
    .RESET_B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][12] ));
 sky130_fd_sc_hd__dfrtp_1 _5350_ (.CLK(clk),
    .D(_0726_),
    .RESET_B(_0342_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][13] ));
 sky130_fd_sc_hd__dfrtp_1 _5351_ (.CLK(clk),
    .D(_0727_),
    .RESET_B(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][14] ));
 sky130_fd_sc_hd__dfrtp_1 _5352_ (.CLK(clk),
    .D(_0728_),
    .RESET_B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][15] ));
 sky130_fd_sc_hd__dfrtp_1 _5353_ (.CLK(clk),
    .D(_0729_),
    .RESET_B(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][16] ));
 sky130_fd_sc_hd__dfrtp_1 _5354_ (.CLK(clk),
    .D(_0730_),
    .RESET_B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][17] ));
 sky130_fd_sc_hd__dfrtp_1 _5355_ (.CLK(clk),
    .D(_0731_),
    .RESET_B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][18] ));
 sky130_fd_sc_hd__dfrtp_1 _5356_ (.CLK(clk),
    .D(_0732_),
    .RESET_B(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][19] ));
 sky130_fd_sc_hd__dfrtp_1 _5357_ (.CLK(clk),
    .D(_0733_),
    .RESET_B(_0349_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][20] ));
 sky130_fd_sc_hd__dfrtp_1 _5358_ (.CLK(clk),
    .D(_0734_),
    .RESET_B(_0350_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][21] ));
 sky130_fd_sc_hd__dfrtp_1 _5359_ (.CLK(clk),
    .D(_0735_),
    .RESET_B(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][22] ));
 sky130_fd_sc_hd__dfrtp_1 _5360_ (.CLK(clk),
    .D(_0736_),
    .RESET_B(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][23] ));
 sky130_fd_sc_hd__dfrtp_1 _5361_ (.CLK(clk),
    .D(_0737_),
    .RESET_B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][24] ));
 sky130_fd_sc_hd__dfrtp_1 _5362_ (.CLK(clk),
    .D(_0738_),
    .RESET_B(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][25] ));
 sky130_fd_sc_hd__dfrtp_1 _5363_ (.CLK(clk),
    .D(_0739_),
    .RESET_B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][26] ));
 sky130_fd_sc_hd__dfrtp_1 _5364_ (.CLK(clk),
    .D(_0740_),
    .RESET_B(_0356_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][27] ));
 sky130_fd_sc_hd__dfrtp_1 _5365_ (.CLK(clk),
    .D(_0741_),
    .RESET_B(_0357_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][28] ));
 sky130_fd_sc_hd__dfrtp_1 _5366_ (.CLK(clk),
    .D(_0742_),
    .RESET_B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][29] ));
 sky130_fd_sc_hd__dfrtp_1 _5367_ (.CLK(clk),
    .D(_0743_),
    .RESET_B(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][30] ));
 sky130_fd_sc_hd__dfrtp_1 _5368_ (.CLK(clk),
    .D(_0744_),
    .RESET_B(_0360_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\RF0.regs[0][31] ));
 sky130_fd_sc_hd__dfrtp_1 _5369_ (.CLK(clk),
    .D(_0745_),
    .RESET_B(_0361_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _5370_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[1] ));
 sky130_fd_sc_hd__dfrtp_1 _5371_ (.CLK(clk),
    .D(_0747_),
    .RESET_B(_0363_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[2] ));
 sky130_fd_sc_hd__dfrtp_1 _5372_ (.CLK(clk),
    .D(_0748_),
    .RESET_B(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[3] ));
 sky130_fd_sc_hd__dfrtp_1 _5373_ (.CLK(clk),
    .D(_0749_),
    .RESET_B(_0365_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[4] ));
 sky130_fd_sc_hd__dfrtp_1 _5374_ (.CLK(clk),
    .D(_0750_),
    .RESET_B(_0366_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[5] ));
 sky130_fd_sc_hd__dfrtp_1 _5375_ (.CLK(clk),
    .D(_0751_),
    .RESET_B(_0367_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[6] ));
 sky130_fd_sc_hd__dfrtp_1 _5376_ (.CLK(clk),
    .D(_0752_),
    .RESET_B(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[7] ));
 sky130_fd_sc_hd__dfrtp_1 _5377_ (.CLK(clk),
    .D(_0753_),
    .RESET_B(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[8] ));
 sky130_fd_sc_hd__dfrtp_1 _5378_ (.CLK(clk),
    .D(_0754_),
    .RESET_B(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[9] ));
 sky130_fd_sc_hd__dfrtp_1 _5379_ (.CLK(clk),
    .D(_0755_),
    .RESET_B(_0371_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[10] ));
 sky130_fd_sc_hd__dfrtp_1 _5380_ (.CLK(clk),
    .D(_0756_),
    .RESET_B(_0372_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[11] ));
 sky130_fd_sc_hd__dfrtp_1 _5381_ (.CLK(clk),
    .D(_0757_),
    .RESET_B(_0373_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[12] ));
 sky130_fd_sc_hd__dfrtp_1 _5382_ (.CLK(clk),
    .D(_0758_),
    .RESET_B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[13] ));
 sky130_fd_sc_hd__dfrtp_1 _5383_ (.CLK(clk),
    .D(_0759_),
    .RESET_B(_0375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[14] ));
 sky130_fd_sc_hd__dfrtp_1 _5384_ (.CLK(clk),
    .D(_0760_),
    .RESET_B(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[15] ));
 sky130_fd_sc_hd__dfrtp_1 _5385_ (.CLK(clk),
    .D(_0761_),
    .RESET_B(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[16] ));
 sky130_fd_sc_hd__dfrtp_1 _5386_ (.CLK(clk),
    .D(_0762_),
    .RESET_B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[17] ));
 sky130_fd_sc_hd__dfrtp_1 _5387_ (.CLK(clk),
    .D(_0763_),
    .RESET_B(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[18] ));
 sky130_fd_sc_hd__dfrtp_1 _5388_ (.CLK(clk),
    .D(_0764_),
    .RESET_B(_0380_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[19] ));
 sky130_fd_sc_hd__dfrtp_1 _5389_ (.CLK(clk),
    .D(_0765_),
    .RESET_B(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[20] ));
 sky130_fd_sc_hd__dfrtp_1 _5390_ (.CLK(clk),
    .D(_0766_),
    .RESET_B(_0382_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[21] ));
 sky130_fd_sc_hd__dfrtp_1 _5391_ (.CLK(clk),
    .D(_0767_),
    .RESET_B(_0383_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[22] ));
 sky130_fd_sc_hd__dfrtp_1 _5392_ (.CLK(clk),
    .D(_0768_),
    .RESET_B(_0384_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[23] ));
 sky130_fd_sc_hd__dfrtp_1 _5393_ (.CLK(clk),
    .D(_0769_),
    .RESET_B(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[24] ));
 sky130_fd_sc_hd__dfrtp_1 _5394_ (.CLK(clk),
    .D(_0770_),
    .RESET_B(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[25] ));
 sky130_fd_sc_hd__dfrtp_1 _5395_ (.CLK(clk),
    .D(_0771_),
    .RESET_B(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[26] ));
 sky130_fd_sc_hd__dfrtp_1 _5396_ (.CLK(clk),
    .D(_0772_),
    .RESET_B(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[27] ));
 sky130_fd_sc_hd__dfrtp_1 _5397_ (.CLK(clk),
    .D(_0773_),
    .RESET_B(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[28] ));
 sky130_fd_sc_hd__dfrtp_1 _5398_ (.CLK(clk),
    .D(_0774_),
    .RESET_B(_0390_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[29] ));
 sky130_fd_sc_hd__dfrtp_1 _5399_ (.CLK(clk),
    .D(_0775_),
    .RESET_B(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\IM0.addr[30] ));
 sky130_fd_sc_hd__dfrtp_1 _5400_ (.CLK(clk),
    .D(_0776_),
    .RESET_B(_0392_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5401_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\disp.digits[0] ));
 sky130_fd_sc_hd__dfxtp_1 _5402_ (.CLK(clk),
    .D(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[1] ));
 sky130_fd_sc_hd__dfxtp_1 _5403_ (.CLK(clk),
    .D(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[2] ));
 sky130_fd_sc_hd__dfxtp_1 _5404_ (.CLK(clk),
    .D(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[3] ));
 sky130_fd_sc_hd__dfxtp_1 _5405_ (.CLK(clk),
    .D(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[4] ));
 sky130_fd_sc_hd__dfxtp_1 _5406_ (.CLK(clk),
    .D(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[5] ));
 sky130_fd_sc_hd__dfxtp_1 _5407_ (.CLK(clk),
    .D(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[6] ));
 sky130_fd_sc_hd__dfxtp_1 _5408_ (.CLK(clk),
    .D(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[7] ));
 sky130_fd_sc_hd__dfxtp_1 _5409_ (.CLK(clk),
    .D(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[8] ));
 sky130_fd_sc_hd__dfxtp_1 _5410_ (.CLK(clk),
    .D(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[9] ));
 sky130_fd_sc_hd__dfxtp_1 _5411_ (.CLK(clk),
    .D(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[10] ));
 sky130_fd_sc_hd__dfxtp_1 _5412_ (.CLK(clk),
    .D(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[11] ));
 sky130_fd_sc_hd__dfxtp_1 _5413_ (.CLK(clk),
    .D(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[12] ));
 sky130_fd_sc_hd__dfxtp_1 _5414_ (.CLK(clk),
    .D(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[13] ));
 sky130_fd_sc_hd__dfxtp_1 _5415_ (.CLK(clk),
    .D(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[14] ));
 sky130_fd_sc_hd__dfxtp_1 _5416_ (.CLK(clk),
    .D(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\disp.digits[15] ));
 sky130_fd_sc_hd__dfxtp_1 _5417_ (.CLK(clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5418_ (.CLK(clk),
    .D(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _5419_ (.CLK(clk),
    .D(_0777_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net34));
 sky130_fd_sc_hd__dfxtp_1 _5420_ (.CLK(clk),
    .D(_0778_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net35));
 sky130_fd_sc_hd__dfxtp_1 _5421_ (.CLK(clk),
    .D(_0779_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net36));
 sky130_fd_sc_hd__dfxtp_1 _5422_ (.CLK(clk),
    .D(_0780_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap45 (.A(_1924_),
    ...
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__buf_1 max_cap46 (.A(_1299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap47 (.A(_1242_),
    ...
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkbuf_1 wire48 (.A(_0786_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
