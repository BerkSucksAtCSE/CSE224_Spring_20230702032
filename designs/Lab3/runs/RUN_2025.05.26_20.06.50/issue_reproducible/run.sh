...
export CURRENT_DEF='./results/floorplan/ZeroToFiveCounter.def';
export CURRENT_NETLIST='./results/synthesis/ZeroToFiveCounter.v';
export CURRENT_ODB='./results/floorplan/ZeroToFiveCounter.odb';
...
export SAVE_DEF='./tmp/placement/7-global_skip_io.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./tmp/placement/7-global_skip_io.odb';
export SAVE_POWERED_NETLIST='./tmp/placement/7-global_skip_io.pnl.v';
