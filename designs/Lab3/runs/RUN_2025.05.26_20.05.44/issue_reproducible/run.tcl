...
set ::env(CURRENT_DEF) "./results/floorplan/ZeroToFiveCounter.def";
set ::env(CURRENT_NETLIST) "./results/synthesis/ZeroToFiveCounter.v";
set ::env(CURRENT_ODB) "./results/floorplan/ZeroToFiveCounter.odb";
...
set ::env(SAVE_DEF) "./tmp/placement/7-global_skip_io.def";
set ::env(SAVE_NETLIST) "./out.v";
set ::env(SAVE_ODB) "./tmp/placement/7-global_skip_io.odb";
set ::env(SAVE_POWERED_NETLIST) "./tmp/placement/7-global_skip_io.pnl.v";
